...
export function PresetWizard({ onComplete }: PresetWizardProps) {
	...
	const isRecommended = (preset: PresetManifest) =>
		...
		<div class="view-preset">
			<div class="preset-header">
				...
				<p class="preset-subtitle">
					Choose how your workspace should be set up.
				</p>
			</div>
			...
			{!loading && presets.length > 0 && (
				<div class="preset-cards">
					{presets.map((preset) => (
						...
						>
							{isRecommended(preset) && (
								<div class="preset-card-badge">Recommended</div>
							)}
			...
			{applying && (
				<div class="preset-progress">
					<div class="spinner" />
					<span>
						Configuring your workspace... This takes about 30 seconds.
					</span>
				</div>
			)}
		</div>
