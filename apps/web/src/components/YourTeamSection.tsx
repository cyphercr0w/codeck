	...
	return (
		<>
			<div class="yt-card" onClick={onSelect}>
				...
				{agent.description && <p class="yt-card-desc">{agent.description}</p>}
	...
	return (
		<div>
			...
			<div class="yt-tool-add-row">
				<input
					type="text"
					placeholder="Add tool name (e.g. Bash, Read, Edit)"
					value={input}
	...
	return (
		<div class="yt-edit">
			...
			<form onSubmit={handleSave as any}>
				...
				{error && (
					<p class="text-error" style="margin-bottom: 12px; font-size: 13px">
						{error}
					</p>
				)}
	...
	return (
		<div class="content-section">
			<div class="home-content">
				...
				{deleteError && (
					<p class="text-error" style="font-size: 13px; margin-bottom: 12px">
						{deleteError}
					</p>
				)}
