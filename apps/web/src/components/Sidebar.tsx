  ...
  if (collapsed) {
    ...
    return (
      <div class="sidebar-usage collapsed">
        <div class="sidebar-usage-dot" style={{ background: barColor(p5) }} title={`5h: ${p5}%`} />
        <div class="sidebar-usage-dot" style={{ background: barColor(p7) }} title={`7d: ${p7}%`} />
      </div>
    );
  }
    ...
    <div class="sidebar-usage">
      ...
      {usage.fiveHour && (
        <div class="sidebar-usage-row">
          ...
          <div class="sidebar-usage-track">
            <div class="sidebar-usage-fill" style={{ width: `${Math.min(100, usage.fiveHour.percent)}%`, background: barColor(usage.fiveHour.percent) }} />
          </div>
      ...
      {usage.sevenDay && (
        <div class="sidebar-usage-row">
          ...
          <div class="sidebar-usage-track">
            <div class="sidebar-usage-fill" style={{ width: `${Math.min(100, usage.sevenDay.percent)}%`, background: barColor(usage.sevenDay.percent) }} />
          </div>
