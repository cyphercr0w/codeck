...
// NOTE: Bearer tokens stored in localStorage — accepted technical debt.
// localStorage is vulnerable to XSS. Mitigation: CSP headers + input sanitization.
// Future: migrate to httpOnly cookies with SameSite=Strict.
